...
var vec__25431 = axis;
var a_x = cljs.core.nth.call(null,vec__25431,(0),null);
var a_y = cljs.core.nth.call(null,vec__25431,(1),null);
var a_z = cljs.core.nth.call(null,vec__25431,(2),null);
var vec__25432 = v;
var x = cljs.core.nth.call(null,vec__25432,(0),null);
var y = cljs.core.nth.call(null,vec__25432,(1),null);
var z = cljs.core.nth.call(null,vec__25432,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__25433,p__25434){
var vec__25437 = p__25433;
var u1 = cljs.core.nth.call(null,vec__25437,(0),null);
var u2 = cljs.core.nth.call(null,vec__25437,(1),null);
var u3 = cljs.core.nth.call(null,vec__25437,(2),null);
var vec__25438 = p__25434;
var v1 = cljs.core.nth.call(null,vec__25438,(0),null);
var v2 = cljs.core.nth.call(null,vec__25438,(1),null);
var v3 = cljs.core.nth.call(null,vec__25438,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__25439_SHARP_){
return (p1__25439_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__25440_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__25441_SHARP_,angle_lr),angle_ud);
...
var map__25448 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__25448__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__25448__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4423__auto__ = (function (){var pred__25450 = cljs.core._EQ_;
var expr__25451 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__25450.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__25451))){
return straight;
} else {
if(cljs.core.truth_(pred__25450.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__25451))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__25450.call(null,quil.middlewares.navigation_3d.space,expr__25451))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__25450.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__25451))){
return up;
} else {
if(cljs.core.truth_(pred__25450.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__25451))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__25450.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__25451))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4423__auto__,map__25448,map__25448__$1,up,straight){
return (function (p1__25442_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__25442_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4423__auto__,map__25448,map__25448__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__25453_SHARP_);
});})(initial_state))
);
});
/**
...
var map__25459_25464 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__25459_25465__$1 = ((((!((map__25459_25464 == null)))?((((map__25459_25464.cljs$lang$protocol_mask$partition0$ & (64))) || (map__25459_25464.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25459_25464):map__25459_25464);
var vec__25460_25466 = cljs.core.get.call(null,map__25459_25465__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_25467 = cljs.core.nth.call(null,vec__25460_25466,(0),null);
var c_y_25468 = cljs.core.nth.call(null,vec__25460_25466,(1),null);
var c_z_25469 = cljs.core.nth.call(null,vec__25460_25466,(2),null);
var vec__25461_25470 = cljs.core.get.call(null,map__25459_25465__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_25471 = cljs.core.nth.call(null,vec__25461_25470,(0),null);
var u_y_25472 = cljs.core.nth.call(null,vec__25461_25470,(1),null);
var u_z_25473 = cljs.core.nth.call(null,vec__25461_25470,(2),null);
var vec__25462_25474 = cljs.core.get.call(null,map__25459_25465__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_25475 = cljs.core.nth.call(null,vec__25462_25474,(0),null);
var p_y_25476 = cljs.core.nth.call(null,vec__25462_25474,(1),null);
var p_z_25477 = cljs.core.nth.call(null,vec__25462_25474,(2),null);
quil.core.camera.call(null,p_x_25475,p_y_25476,p_z_25477,(p_x_25475 + c_x_25467),(p_y_25476 + c_y_25468),(p_z_25477 + c_z_25469),u_x_25471,u_y_25472,u_z_25473);
