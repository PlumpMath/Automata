...
return cljs.core.merge.call(null,initial_state,p1__25422_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_25423 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_25424 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_25423);
var pos_25425 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_25423);
quil.core.scale.call(null,zoom_25424);

var tr__24046__auto___25426 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_25424) - cljs.core.first.call(null,pos_25425)),(((quil.core.height.call(null) / (2)) / zoom_25424) - cljs.core.second.call(null,pos_25425))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__24046__auto___25426);
